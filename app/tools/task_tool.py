...
@tool
async def create_reminder(phone_number: str, title: str, due_datetime: str, repeat: str = "none") -> str:
...
@tool
async def assign_task(phone_number: str, assignee_phone: str, title: str, assignee_email: str = None, due_datetime: str = None, description: str = "") -> str:
...
@tool
async def list_tasks(phone_number: str, status: str = "pending") -> str:
