...
@tool
async def log_expense(phone_number: str, amount: float, category: str = "General", description: str = "") -> str:
...
@tool
async def get_expense_summary(phone_number: str, period: str = "weekly") -> str:
